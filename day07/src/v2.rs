//! V2. Similar to V1 but we calculate all sizes of directories once
//! and then while doing tree traversal we already have information
//! about the size of the item.
//!
